...
// SparkLend (Spark Protocol) mainnet — Aave v3 fork
// Source: https://github.com/sparkdotfi/spark-address-registry/blob/master/src/SparkLend.sol
const DATA_PROVIDER = "0xFc21d6d146E6086B8359705C8b28512a983db0cb" as const;
const ORACLE        = "0x8105f69D9C41644c6A0803fDA7D03Aa70996cFD9" as const;
...
export async function fetchSparkPositions(address: string): Promise<BorrowPosition[]> {
